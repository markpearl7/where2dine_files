...
calculations_timeout= setTimeout( function() {updateformfields(only_summary,level); },0);
}
...
success:function(dat) {
	...
	var op_count=obj_size(data);
		...
		if (op_count<60) setTimeout(function() { InputRules('calculation'); },0); //  daca sunt prea multe reguli nu se mai aplica ca sa nu fie delay prea mare
