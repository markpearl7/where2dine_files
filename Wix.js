...
Wix.Dashboard = (function() {
	...
	/**
         ...
         *
         * @since SDK 1.32.0
         * @param state (String) new app's state to push into the dashboard app's history stack
         */
        pushState: function (state) {
          ...
          _w.sendMessageInternal2(_w.MessageTypes.APP_STATE_CHANGED, {'state': state});
        }
    }
})();
var Wix = Wix || {};
