// InstantSearch+ for Wix - Oct. 2013
// Copyright (c) Fast Simon Inc.
// wix_instantsearchplus_widget-fixed.v.0.1.js
...
if (ie8_mode)	{
	...
	inputbox.style.backgroundImage = 'url(http://wix.instantsearchplus.com/wix_widget/images/search_icon2.png)';
	...
	if ( Wix.Utils.getViewMode() == 'editor' && localStorage) 	{		
		...
		if (prev_is_premium == false && is_premium == true)	{
			...
			if (isp_campaign != null && isp_campaign != '')	{
				var js = 'http://wix.instantsearchplus.com/wix_upgrade_campaign?v=' + CLIENT_VER + '&instance=' + encodeURIComponent(instanceId) + '&isp_campaign=' + encodeURIComponent(isp_campaign);
				injectJS( js );			
			}
		}				
...
function updateSiteInfo(siteInfo)	{
	...
	if (!isp_load_once)	{
		...
		var inject_url = 'http://wix.instantsearchplus.com/wix_widget_load?wix_v2=1&v=' + CLIENT_VER + '&ie8=' + (0+ie8_mode) + '&instance=' + encodeURIComponent(instanceId) + '&locale=' + encodeURIComponent(editor_locale) + '&url=' + encodeURIComponent(this_url) + '&site_base_url=' + encodeURIComponent(isp_obj['base_url']) + '&wix_instance=' + encodeURIComponent(wix_instance);
	...
	if ( isp_obj['base_url'].indexOf('editor.wix')==-1 )	{
		...
		var isp_pop_url = 'http://wix.instantsearchplus.com/pop?s=' + encodeURIComponent( acp_options.HOSTNAME) + '&instance=' + encodeURIComponent(instanceId) + '&v=' + CLIENT_VER + '&callback=isp_callback_pop2';
...
Wix.addEventListener(Wix.Events.SITE_PUBLISHED, function(data) {	
	Wix.getSiteInfo( function(siteInfo) {	  
		...
		if (this_url.indexOf('editor.wix.com')>=0)	{	this_url = 'editor.wix.com';	}
		if (!isp_load_once)	{			
			injectJS('http://wix.instantsearchplus.com/wix_widget_load?wix_v2=1&v=' + CLIENT_VER + '&ie8=' + (0+ie8_mode) + '&instance=' + encodeURIComponent(instanceId) + '&locale=' + encodeURIComponent(editor_locale) + '&url=' + encodeURIComponent(this_url) + '&site_base_url=' + encodeURIComponent(site_base_url) ) + '&wix_instance=' + encodeURIComponent(wix_instance);
			isp_load_once = true;
		}
		if (site_url == null)	{	alert('publish error');		}		
		
				
		injectJS('http://wix.instantsearchplus.com/wix_site_published?wix_v2=1&v=' + CLIENT_VER + '&instance=' + encodeURIComponent(instanceId) + '&locale=' + encodeURIComponent(editor_locale) + '&url=' + encodeURIComponent(this_url) + '&site_base_url=' + encodeURIComponent(site_base_url));		
	});		
});	
...
Wix.addEventListener(Wix.Events.COMPONENT_DELETED, function(data) {
	Wix.getSiteInfo( function(siteInfo) {	  
		...
		injectJS('http://wix.instantsearchplus.com/wix_widget_deleted?wix_v2=1&v=' + CLIENT_VER + '&instance=' + encodeURIComponent(instanceId) + '&url=' + encodeURIComponent(this_url) + '&site_base_url=' + encodeURIComponent(site_base_url) );			
	});	   
});
